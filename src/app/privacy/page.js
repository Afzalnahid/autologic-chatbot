...
export default function Privacy() {
  return (
    <SiteShell
      ...
      lead={`Autologic ("we", "our", "us") operates an AI-powered chatbot platform at getvoicium.com. This Privacy Policy explains how we collect, use, store, and protect data.`}
    ...
    >
      ...
      <Section title="2. Google Calendar Data — Limited Use Disclosure">
        <p>Autologic's use of data obtained from Google APIs adheres to the Google API Services User Data Policy, including the Limited Use requirements.</p>
