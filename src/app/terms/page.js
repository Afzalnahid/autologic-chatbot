...
export default function Terms() {
  return (
    <SiteShell
      ...
      lead={`These Terms of Service ("Terms") govern your use of Autologic ("we", "our", "us"), an AI-powered customer service chatbot platform operated at getvoicium.com. By creating an account or using the platform, you agree to these Terms.`}
      updated="July 18, 2026"
    >
      <Section title="1. The Service">
        <p>Autologic provides an AI-powered chatbot platform that businesses ("clients") connect to their messaging channels (Facebook, Instagram, WhatsApp) and optionally their Google Calendar to automate customer service, meeting scheduling, and order management.</p>
      </Section>
      ...
      <Section title="7. Intellectual Property">
        <p>Autologic and its underlying technology remain our intellectual property. You are granted a limited, non-exclusive, non-transferable license to use the platform for your business purposes. You may not copy, reverse-engineer, or resell any part of the platform without written permission.</p>
      </Section>
