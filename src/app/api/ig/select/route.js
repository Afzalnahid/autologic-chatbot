...
export async function POST(request) {
  try {
    ...
    // One Instagram account powers exactly one TellMore AI account.
    ...
    const rows = [
      { ok: true, title: "Direct-message replies are live", sub: "TellMore AI answers every DM this account receives, 24/7." },
      commentsOk
