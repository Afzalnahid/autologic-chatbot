...
export const metadata = pageMeta({
  title: "Contact — TellMore AI",
  description: "Reach the TellMore AI team for support, sales or general questions about the chatbot platform. We usually reply within 24 hours.",
  path: "/contact",
});
...
export default function Contact() {
  return (
    <SiteShell
      eyebrow="Contact"
      title="Get in touch"
      lead="Have a question about TellMore AI, need help setting up, or want to talk about your business? We're here to help."
    >
      <div style={{ marginTop: 34 }}>
        ...
        <InfoCard
          ...
          note={
            <>
              TellMore AI is a product of {COMPANY.legalName}, our registered business.{" "}
        ...
        <InfoCard
          ...
          note={
            <>
              ...
              <a href="/dashboard" style={link}>TellMore AI dashboard</a>.
            </>
          }
        >
