...
// Sample questions shown in Settings and onboarding. Ten per business type:
// enough that almost every owner finds one close to their own shop or firm,
// each written the way an owner would brief a new employee — concrete prices,
// delivery, payment and the one policy customers always ask about.
export const SAMPLE_ECOM=[
  ...
  {label:"Cosmetics & skincare",text:"We sell authentic imported cosmetics and skincare — serums, creams, sunscreen and makeup from Korean and international brands. Prices are 300 to 5000 taka. Every product is 100% original with the batch code visible. Delivery is 60 taka inside Dhaka (1-2 days) and 120 taka outside (2-4 days). Cash on delivery and bKash. Opened products cannot be returned, but wrong or damaged items are replaced free."},
  {label:"Electronics & gadgets",text:"We sell gadgets and accessories — earbuds, smart watches, power banks, chargers and speakers. Prices are 500 to 8000 taka. Every item carries a 6-month service warranty. Delivery all over Bangladesh: 60 taka in Dhaka, 120 taka outside, 1-3 days. Cash on delivery is available and customers can test the product in front of the rider before paying."},
  {label:"Shoes & bags",text:"We sell shoes and bags for men and women — sneakers, loafers, sandals, handbags and backpacks. Prices are 800 to 4500 taka. Always ask for the size; we have a size chart in inches. Delivery is 70 taka inside Dhaka and 140 taka outside, 2-4 days. Cash on delivery and bKash. Size exchange within 7 days if the item is unused."},
  {label:"Baby & kids",text:"We sell baby and kids items — clothes for ages 0 to 10, toys, feeders and diapers. Prices are 250 to 3000 taka. All fabrics are cotton and skin-friendly. Ask the baby's age to suggest the right size. Delivery is 70 taka in Dhaka (1-2 days) and 130 taka outside (2-3 days). Cash on delivery. Unused items can be exchanged within 3 days."},
  {label:"Furniture & decor",text:"We sell home furniture and decor — bed frames, wardrobes, study tables, wall shelves and lamps. Prices are 2000 to 45000 taka. Made-to-order pieces take 7-10 days. Delivery inside Dhaka is 300 to 800 taka depending on size; outside Dhaka goes by courier at the customer's cost. 30% advance by bKash confirms an order, the rest is due on delivery. One year warranty on wood joints."},
  {label:"Grocery & organic",text:"We sell organic and homemade food — honey, ghee, dates, nuts, spices and cold-pressed oils. Prices are 200 to 2500 taka. Everything is sourced directly from farmers. Orders before 5pm are dispatched the same day. Delivery is 60 taka in Dhaka (1-2 days) and 130 taka outside. Cash on delivery and bKash. Returns are accepted if the seal is intact."},
  {label:"Books & stationery",text:"We sell books and stationery — academic guides, Islamic books, novels, notebooks and art supplies. Books are 150 to 1200 taka. If a title is out of stock we can pre-order it in 5-7 days. Delivery all over Bangladesh: 50 taka in Dhaka, 110 taka outside. Cash on delivery. No returns, but misprinted or damaged books are replaced free."},
];
export const SAMPLE_AGENCY=[
  ...
  {label:"Travel agency",text:"We are a travel agency in Dhaka. We arrange air tickets, visa processing, hotel bookings and holiday packages — Cox's Bazar from 8500 taka, Malaysia and Thailand from 45000 taka per person. Visa processing takes 7-15 working days depending on the country. We are open Saturday to Thursday, 10am to 8pm, and offer a free consultation call."},
  {label:"Real estate",text:"We are a real estate company in Dhaka. We sell ready flats and plots — flats from 65 lakh taka in Bashundhara and Uttara — and also handle rentals. Ask for the client's preferred location, budget and size to suggest options. Site visits are free and can be booked any day between 10am and 6pm. Bank loan support is available."},
  {label:"Beauty salon",text:"We run a ladies' beauty salon in Dhanmondi. Services include haircuts from 500 taka, facials 800 to 2500 taka, party makeup 3000 to 8000 taka and bridal packages from 15000 taka. Makeup needs an appointment; walk-ins are fine for haircuts. Open every day 11am to 8pm except Wednesday. A 500 taka bKash advance confirms a bridal booking."},
  {label:"Photography studio",text:"We are a photography and videography studio. We cover weddings from 25000 taka, birthdays from 8000 taka, and corporate events. A wedding package includes two photographers, 400+ edited photos and a highlight video. Edited photos are delivered in 15-20 days. A 30% advance confirms the date. We are based in Dhaka and cover events anywhere in Bangladesh."},
  {label:"Software & web",text:"We build websites and software. A business website costs 15000 to 50000 taka and takes 2-3 weeks; e-commerce sites start from 40000 taka. We also do app development and maintenance contracts. Every project starts with a free requirement call. 50% advance to start, the rest on delivery. Support is free for the first 3 months."},
  {label:"Event management",text:"We are an event management company in Dhaka. We arrange weddings, holud, birthdays and corporate programs — stage, decoration, catering, sound and lights. Wedding decoration packages start from 40000 taka. We need at least 2 weeks notice for a full event. A site visit and quotation are free. A 30% advance confirms the date."},
  {label:"Law / consultancy",text:"We are a law chamber in Dhaka. We handle company registration, trademark, land documentation, family matters and notary work. Company registration takes 7-10 working days with fees from 15000 taka. The first 15 minute phone consultation is free; a full consultation is 2000 taka. Chamber hours are Sunday to Thursday, 4pm to 9pm, by appointment."},
];
