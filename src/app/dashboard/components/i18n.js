...
const DICT = {
  en: {
    ...
    "ov.kpi.convToday": "Conversations today", "ov.kpi.handled": "Handled by AI", "ov.kpi.ordersToday": "Orders today", "ov.kpi.revenueToday": "Revenue today",
    "ov.kpi.bookingsToday": "Bookings today", "ov.kpi.meetingsWeek": "Meetings this week",
    "ov.totalByAI": "{n} total · {p}% by AI", "ov.customerMsgs": "Customer messages", "ov.open": "Open", "ov.allOrders": "All orders", "ov.chatsToday": "chats today",
    ...
    "inbox.locked.title": "Your inbox is locked", "inbox.locked.cta": "Renew or upgrade",
    "inbox.locked.body": "Your plan has ended, so reading and answering chats is paused. Every message your customers send is still being saved — renew and they are all here, nothing is lost.",
    "inbox.locked.waiting": "{n} customers are waiting", "inbox.locked.waitingSince": "{n} customers have written since {date}",
    "ov.needsLocked": "Locked until you renew. Messages are still being saved.",
  ...
  bn: {
    ...
    "ov.kpi.convToday": "আজকের কথোপকথন", "ov.kpi.handled": "AI সামলেছে", "ov.kpi.ordersToday": "আজকের অর্ডার", "ov.kpi.revenueToday": "আজকের আয়",
    "ov.kpi.bookingsToday": "আজকের বুকিং", "ov.kpi.meetingsWeek": "এই সপ্তাহের মিটিং",
    "ov.totalByAI": "মোট {n} · {p}% AI-এর", "ov.customerMsgs": "কাস্টমারের মেসেজ", "ov.open": "খুলুন", "ov.allOrders": "সব অর্ডার", "ov.chatsToday": "আজকের চ্যাট",
    ...
    "inbox.locked.title": "আপনার ইনবক্স লক করা", "inbox.locked.cta": "রিনিউ বা আপগ্রেড করুন",
    "inbox.locked.body": "আপনার প্যাকেজের মেয়াদ শেষ, তাই চ্যাট পড়া আর উত্তর দেওয়া বন্ধ আছে। কাস্টমাররা যা লিখছেন সবই জমা হচ্ছে — রিনিউ করলেই সব এখানে পাবেন, কিছুই হারাবে না।",
    "inbox.locked.waiting": "{n} জন কাস্টমার অপেক্ষায়", "inbox.locked.waitingSince": "{date} থেকে {n} জন কাস্টমার লিখেছেন",
    "ov.needsLocked": "রিনিউ না করা পর্যন্ত লক। মেসেজ জমা হচ্ছে।",
