...
export const D = {
  ...
  blue: "#7B1C3E", blueSoft: "#F6EAEF", mint: "#2ED3A7", mintSoft: "#E7F9F3",
...
export const SAMPLE = {
  ...
  channels: [
    { id: "messenger", icon: "ti-brand-messenger", name: "Facebook Messenger", handle: "TellMore AI Systems", state: "live", share: 42 },
