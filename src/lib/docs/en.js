    ...
    blocks: [
      ...
      { h: "Around every tab",
        p: [
          ...
          "**Light and dark.** The dashboard and the app follow your device: if your phone or computer is in dark mode, so is TellMore AI, and when the phone switches by itself in the evening the app switches with it — while it is open, without reloading. The **moon / sun** button changes it for now; the next time your device changes mode, TellMore AI goes back to following it.",
        ] },
      ...
      { h: "The four cards",
        table: { head: ["Card", "What it shows"],
          rows: [
            ["**Conversations today**", "How many different people wrote to you today, against yesterday"],
            ["**Handled by AI**", "The share of the last 7 days' conversations the bot finished on its own, and how that moved against the week before"],
            ["**Orders today**", "Orders placed today, and how many more or fewer than yesterday"],
            ["**Revenue today**", "Money from today's orders (cancelled and returned ones left out), against yesterday"],
          ] },
        biz: "ecommerce" },
      { table: { head: ["Card", "What it shows"],
          rows: [
            ["**Conversations today**", "How many different people wrote to you today, against yesterday"],
            ["**Handled by AI**", "The share of the last 7 days' conversations the bot finished on its own"],
            ["**Bookings today**", "Meetings booked today, against yesterday"],
            ["**Meetings this week**", "Meetings in the next seven days that are not cancelled"],
          ] },
        biz: "agency" },
      { p: ["A green number beside a card is a rise, a red one a fall. On a laptop each card also draws the last seven days as a small line. **Messages this week** shows two bars per day — what customers wrote, and what the bot answered — with the week's total and the bot's share above them. The **Analytics** tab has the longer view and the reasons behind it."] },
      { p: ["**Needs you** lists the chats waiting on a person — someone asked for one, a complaint was tagged, or a customer wrote and you have not opened it — each with why, and an **Open** button that lands in that chat. **Recent orders** is the newest five with their status; **Channels** says how many people wrote to each Page, account or number today."] },
