...
(function () {
  ...
  var CSS =
    ...
    "background:#7B1C3E;color:#fff;border:none;cursor:pointer;display:flex;align-items:center;" +
    ...
    ".bot{align-self:flex-start;background:#0F1420;border:1px solid #1F2839;border-left:2px solid #7B1C3E}" +
    ".me{align-self:flex-end;background:#7B1C3E;color:#fff}" +
    ...
    ".ft input:focus{border-color:#C04A72}" +
    ".ft button{background:#7B1C3E;color:#fff;border:none;border-radius:9px;padding:0 16px;" +
