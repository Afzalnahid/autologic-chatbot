...
values
  ...
  ('trial', 'both', 'Free Trial', 'Try everything for a few days', 0, true, true, 0, 0,
   ...
   '{"vision":true,"voice":true,"comments":true,"widget":true,"broadcast":true,"followup":true,"kb":true,"photo_import":true,"website_import":true,"assistant":true,"calendar":true,"analytics":true,"byok":true}'::jsonb,
   '["Every feature switched on","30 bot replies a day (about 5-6 customers)","1 channel (Facebook, Instagram or WhatsApp)","20 products or 2 documents","No card needed"]'::jsonb, false),
  ...
  ('shop_starter', 'ecommerce', 'Shop Starter', 'One channel, your catalogue answering for itself', 1, true, true, 1500, 15000,
   ...
   '{"vision":true,"voice":true,"comments":true,"widget":true,"broadcast":true,"followup":true,"kb":true,"photo_import":true,"website_import":true,"assistant":true,"calendar":true,"analytics":true,"byok":true}'::jsonb,
   '["3,000 bot replies / month","1 channel of your choice","300 products","20 website imports, 4 broadcasts a month","Every feature — nothing is held back"]'::jsonb, false),
  ('shop_growth', 'ecommerce', 'Shop Growth', 'Every channel, and customers who send photos instead of names', 2, true, true, 3500, 35000,
   ...
   '{"vision":true,"voice":true,"comments":true,"widget":true,"broadcast":true,"followup":true,"kb":true,"photo_import":true,"website_import":true,"assistant":true,"calendar":true,"analytics":true,"byok":true}'::jsonb,
   '["15,000 bot replies / month","All 3 channels — Facebook, Instagram, WhatsApp","3,000 products","200 website imports, 20 broadcasts a month","Every feature — nothing is held back"]'::jsonb, true),
  ('shop_scale', 'ecommerce', 'Shop Scale', 'For a catalogue and a crowd that keep growing', 3, true, true, 6000, 60000,
   ...
   '{"vision":true,"voice":true,"comments":true,"widget":true,"broadcast":true,"followup":true,"kb":true,"photo_import":true,"website_import":true,"assistant":true,"calendar":true,"analytics":true,"byok":true}'::jsonb,
   '["50,000 bot replies / month","All 3 channels — Facebook, Instagram, WhatsApp","Unlimited products","Unlimited website imports and broadcasts","Priority support"]'::jsonb, false),
  ...
  ('svc_starter', 'agency', 'Service Starter', 'One channel, answering from your own documents', 4, true, true, 1500, 15000,
   ...
   '{"vision":true,"voice":true,"comments":true,"widget":true,"broadcast":true,"followup":true,"kb":true,"photo_import":true,"website_import":true,"assistant":true,"calendar":true,"analytics":true,"byok":true}'::jsonb,
   '["3,000 bot replies / month","1 channel of your choice","10 knowledge documents","20 website imports, 4 broadcasts a month","Every feature — nothing is held back"]'::jsonb, false),
  ('svc_growth', 'agency', 'Service Growth', 'Every channel, and meetings booked while you sleep', 5, true, true, 3500, 35000,
   ...
   '{"vision":true,"voice":true,"comments":true,"widget":true,"broadcast":true,"followup":true,"kb":true,"photo_import":true,"website_import":true,"assistant":true,"calendar":true,"analytics":true,"byok":true}'::jsonb,
   '["15,000 bot replies / month","All 3 channels — Facebook, Instagram, WhatsApp","40 knowledge documents","200 website imports, 20 broadcasts a month","Every feature — nothing is held back"]'::jsonb, true),
  ('svc_scale', 'agency', 'Service Scale', 'For a practice that answers all day', 6, true, true, 6000, 60000,
   ...
   '{"vision":true,"voice":true,"comments":true,"widget":true,"broadcast":true,"followup":true,"kb":true,"photo_import":true,"website_import":true,"assistant":true,"calendar":true,"analytics":true,"byok":true}'::jsonb,
   '["50,000 bot replies / month","All 3 channels — Facebook, Instagram, WhatsApp","Unlimited knowledge documents","Unlimited website imports and broadcasts","Priority support"]'::jsonb, false)
